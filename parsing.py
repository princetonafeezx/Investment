"""Shared parsing for dates and currency-style amount strings."""
...
def parse_amount(amount_text: str) -> Decimal:
    """Parse a bank-style amount string into a non-negative :class:`~decimal.Decimal` (cents).
    ...
    always ``>= 0``. Values are rounded **half-up** to two decimal places.
